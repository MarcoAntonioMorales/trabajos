...
MySQL - 5.5.16 : Database - proyecto1
*********************************************************************
*/
...
insert  into `alumno_grupo`(`idag`,`id`,`id_grup`) values (1,6,4),(2,6,4);
...
insert  into `grupo`(`id_grup`,`Nombre`,`Avatar`,`Orden`,`Estatus`) values (1,'tic-72',NULL,NULL,'1'),(3,'tic-42',NULL,NULL,'1'),(4,'tic-22',NULL,NULL,'1'),(5,'tic-34','a','a','1'),(6,'tic-77',NULL,NULL,'1');
...
insert  into `materia`(`id_materia`,`Nombrem`,`Avatarm`,`Ordenm`,`Estatusm`) values (1,'Ingles','0','0','1'),(2,'Matematicas',NULL,NULL,'1'),(3,'Historia',NULL,NULL,'1'),(4,'geografia',NULL,NULL,'1');
...
insert  into `usuario`(`id`,`Nombre`,`ApellidoPaterno`,`ApellidoMaterno`,`Telefono`,`Calle`,`NumeroExterior`,`NumeroInterior`,`Colonia`,`Municipio`,`Estado`,`CP`,`Correo`,`Usuario`,`Contrasena`,`Nivel`,`Estatus`) values (1,'juan','mancera','perez','','','','','','','','','','','','1','1'),(2,'jose','perez','leon','','','','','','','','','','','','3','1'),(3,'ana','hernandez','morales','','','','','','','','','','','','3','1'),(6,'raul','granda','morales','','','','','','','','','','','','2','1'),(8,'luis alberto','rodriguez','hernandez','','','','','','','','','','larodriguez','123','1','1'),(9,'marco','morales','martinez','','','','','','','','','','marco','12345','1','1'),(10,'alberto','garcia','nava','','','','','','','','','','','','2','1');
